...
namespace Tests\Madcoders\SyliusTaxonGalleryPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Madcoders\SyliusTaxonGalleryPlugin\Behat\Page\Shop\CreditsPageInterface;
